...
// Fichier séparé de ad-api-provider.spec.ts (pas fusionné) : loadEnv()
// (packages/config) mémoïse au premier appel dans un registre de modules —
// Jest isole ce registre par fichier, donc AD_API_URL ne peut être fixé sur
// un port injoignable qu'en le définissant AVANT le tout premier appel à
